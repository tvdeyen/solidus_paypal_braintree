...
RSpec.describe SolidusPaypalBraintree::ApplePayPayment do
  ...
  let(:payment_type) { SolidusPaypalBraintree::Source::APPLE_PAY }

  it_behaves_like 'a SolidusPaypalBraintree::PaymentMethod'

  describe 'making a payment on an order', vcr: { cassette_name: 'apple_pay_gateway/complete' } do
  ...
  describe "instance methods" do
    ...
    describe "#method_type" do
      ...
      it { is_expected.to eq "braintree_apple_pay" }
    end

    describe '#purchase', vcr: { cassette_name: 'apple_pay_gateway/purchase' } do
    ...
    describe "#authorize" do
      ...
      context 'successful authorization', vcr: { cassette_name: 'apple_pay_gateway/authorize' } do
        include_examples "successful response"
      ...
      context 'different merchant account for currency', vcr: { cassette_name: 'apple_pay_gateway/authorize/merchant_account/EUR' } do
        let(:currency) { 'EUR' }
    ...
    describe "#capture", vcr: { cassette_name: 'apple_pay_gateway/capture' } do
    ...
    describe "#credit", vcr: { cassette_name: 'apple_pay_gateway/credit' } do
    ...
    describe "#void", vcr: { cassette_name: 'apple_pay_gateway/void' } do
    ...
    describe "#cancel", vcr: { cassette_name: 'apple_pay_gateway/cancel' } do
      ...
      context "when the transaction is found" do
        context "and it is voidable", vcr: { cassette_name: 'apple_pay_gateway/cancel/void' } do
        ...
        context "and it is not voidable", vcr: { cassette_name: 'apple_pay_gateway/cancel/refunds' } do
      ...
      context "when the transaction is not found", vcr: { cassette_name: 'apple_pay_gateway/cancel/missing' } do
    ...
    describe "#create_profile" do
      ...
      cassette_options = { cassette_name: "apple_pay_gateway/create_profile" }
